...
public class Apuesta {
    ...
    public Apuesta(MesaRuleta mesa, Jugador jugador, BigDecimal monto, List<CasilleroRuleta> detalleApuesta)
    {
        this.mesa = mesa;
    ...
    public Apuesta(MesaRuleta mesa, Jugador jugador, BigDecimal monto, List<CasilleroRuleta> detalleApuesta, boolean finalizo)
    {
        this.mesa = mesa;
        this.jugador = jugador;
        this.fecha = fechaHoraUtil.ObtenerFechaHoraActual();
	...
	return this.getMesa().equals(that.getMesa()) && this.getJugador().equals(that.getJugador()) 
